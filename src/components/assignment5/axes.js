...
function YAxis (props) {
    ...
    console.log("yTicks", ticks)
    return <g >
        <line y2={height} stroke={'black'}></line>
        {
            ticks.map(tickValue => {
                return <g key={tickValue} transform={`translate(-10, ${yScale(tickValue)+5})`}>
                    <line x1={10} x2={5} y1={yScale.bandwidth()/2-5} y2={yScale.bandwidth()/2-5} stroke="black"></line>
...
function XAxis(props) {
    ...
    console.log("x ticks", xScale.ticks())
